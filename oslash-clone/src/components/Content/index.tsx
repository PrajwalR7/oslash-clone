          ...
          {props.isSuccess ? (
            <div className='flex flex-col h-max justify-between bg-gray-50'>
              ...
              <ReactPaginate
                ...
                pageClassName='transition-all rounded-sm mx-1 px-2 py-1 duration-400 ease-in text-center text-sm flex flex-row border-gray-300 border-[1px] justify-center items-center'
                previousClassName='flex flex-row justify-center items-center'
                previousLinkClassName='px-4 py-2 text-sm bg-indigo-600 text-white mr-20 rounded-md text-sm'
                nextClassName='flex text-sm flex-row justify-center items-center'
                nextLinkClassName='px-4 py-2 bg-indigo-600 text-white ml-20 rounded-md text-sm'
                activeClassName='bg-[#eef2ff]'
